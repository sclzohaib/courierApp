	...
	<sf:form modelAttribute="handInstr" action="${contextRoot}/hand-instr"
		...
		<div class="form-row">
			...
			<div class="col-md-3 mb-3">
				...
				<sf:input type="text" class="form-control" id="prodId"
					path="prodId" />
			</div>
		</div>
		...
		<div class="form-row">
			<div class="col-md-3 mb-3">
				...
				<sf:input type="text" class="form-control" id="sectorId" path="sectorId" />
			</div>
			<div class="col-md-3 mb-3">
		...
		<div class="form-row">
			<div class="col-md-3 mb-3">
				...
				<sf:input type="text" class="form-control" id="countryNo" path="countryNo" />
			</div>
			<div class="col-md-3 mb-3">
